...
![main_page](img/screenshot-index.png)
![main_page](img/screenshot-index2.png)

- Каталог товаров

![catalog_page](img/screenshot-catalog.png)
![catalog_page](img/screenshot-catalog2.png)

- О нас

![about_page](img/screenshot-about.png)
![about_page](img/screenshot-about2.png)

- Мобильная версия страниц

![mobile_main_page](img/screenshot-mobile-index.png)
![mobile_catalog_page](img/screenshot-mobile-catalog.png)
![mobile_about_page](img/screenshot-mobile-about.png)

- Планшетная версия страниц

![tablet_main_page](img/screenshot-tablet-index.png)
![tablet_catalog_page](img/screenshot-tablet-catalog.png)
![tablet_about_page](img/screenshot-tablet-about.png)
